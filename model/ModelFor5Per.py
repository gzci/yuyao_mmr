...
class ModelFor5Per(nn.Module):

    def __init__(self, embed_dim, hidden_dim):
        super(ModelFor5Per, self).__init__()
        ...
        self.al_encode = VariableLengthGRU(input_size=embed_dim,
                                            hidden_size=hidden_dim,
                                            num_layers=2,
                                            batch_first=True,
                                            bidirectional=True)

        self.al_self_attention = Attention(input_size=2 * hidden_dim,
                                            output_size=2 * hidden_dim)
